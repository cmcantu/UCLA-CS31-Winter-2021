...
namespace cs31
{
    ...
    // TODO: called to identify the game ended tied ok!
    ...
    // TODO: called to identify the Human won the game ok!
    // adjust mHumanWon, mComputerWon and mGameOver appropriately
    ...
    // TODO: called to identify the Computer won the game ok!
    // adjust mHumanWon, mComputerWon and mGameOver appropriately
    ...
    // TODO: is the game over? ok!
    bool Board::isGameOver( ) const
    {
        bool b = false; //initialize
            if (mGameOver == true) //check if mark method went through
            b = true;
        
        return(b);
    }

    // TODO: is the game over and has the Human Player already won? ok!
    bool Board::didHumanWin() const
    {
        bool b = false; //initialize
        if (mGameOver == true && mHumanWon == true)
               b = true;
        return(b);
    }
    
    // TODO: is the game over and has the Computer Player already won ok!
    bool Board::didComputerWin() const
    {
        bool b = false; //initialize
        if (mGameOver == true && mComputerWon == true)
                b = true;
        return(b);
    }
